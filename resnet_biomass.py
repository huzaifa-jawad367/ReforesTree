...
class ModifiedDeepForestAGB_CC_Resnet(nn.Module):
    def __init__(self, mlp_hidden_dim=256, feature_dim=12, feature_hidden_dim=128, freeze_backbone=True):
        ...
        backbone_features = 512  # Number of output channels from ResNet50's last convolutional layer
    ...
    def forward(self, x, additional_features):
        ...
        flattened_backbone_features = self.backbone(x)
...
def run_testing():
    ...
    # Load model
    model = ModifiedDeepForestAGB_CC_Resnet(freeze_backbone=True)
